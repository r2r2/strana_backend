...
class ResponseRepresAdditionalAgreement(BaseAgencyModel):
    id: int
    number: Optional[str]
...
class ResponseRepresAdditionalAgreementList(BaseAgencyModel):
    """
    Модель ответа дополнительных соглашений с пагинацией
    """
    count: int
    page_info: dict[str, Any]
    result: list[ResponseRepresAdditionalAgreement]
