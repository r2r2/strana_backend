...
class ResponseSignupInAgencyModel(BaseRepresModel):
    """
    Модель ответа для восстановления представителя как агента в новом агентстве.
    """
...
class RequestSignupInAgencyModel(CamelCaseBaseModel):
    """
    Модель запроса для восстановления представителя как агента в новом агентстве.
    """
