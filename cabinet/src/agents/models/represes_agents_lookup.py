...
class RequestRepresesAgentsLookupModel(BaseAgentModel):
    """
    Модель запроса поиска агента представителя агенства
    """
...
class ResponseRepresesAgentsLookupModel(BaseAgentModel):
    """
    Модель ответа поиска агента представителя агенства
    """
