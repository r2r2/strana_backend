...
class RequestAdminsUsersRetrieveModel(BaseUserModel):
    """
    Модель запроса детального пользователя администратором
    """
...
class _AgentRetrieveModel(BaseUserModel):
    """
    Модель агента пользователя администратором
    """
...
class _AgencyRetrieveModel(BaseUserModel):
    """
    Модель ответа агенства администратором
    """
...
class ResponseAdminsUsersRetrieveModel(BaseUserModel):
    """
    Модель ответа детального пользователя администратором
    """
