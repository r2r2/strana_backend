...
class RequestRepresesUsersLookupModel(BaseUserModel):
    """
    Модель запроса поиска пользователя представителя агенства
    """
...
class ResponseRepresesUsersLookupModel(BaseUserModel):
    """
    Модель ответа поиска пользователя представителя агенства
    """
