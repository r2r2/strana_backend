...
from src.mortgage.exceptions import MortgageConditionMatrixNotFoundError
from src.mortgage.repos import MortgageConditionMatrixRepo, MortgageConditionMatrix
...
class MortgageTicketCheckerService:
    ...
    async def check(self) -> tuple[bool, bool]:
        ...
        if not matrix_conditions:
            raise MortgageConditionMatrixNotFoundError
