...
class AgencyAdditionalAgreement(models.Model):
    ...
    status = models.ForeignKey(
        "documents.AdditionalAgreementStatus",
        models.CASCADE,
        blank=True,
        null=True,
        verbose_name="Статус",
    ...
    creating_data = models.ForeignKey(
        "documents.AgencyAdditionalAgreementCreatingData",
        verbose_name='Данные для формирования ДС (через админку)',
    ...
    class Meta:
        ...
        verbose_name_plural = " 7.3. Дополнительные соглашения"
