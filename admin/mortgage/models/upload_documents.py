...
class MortgageQuestionnaireUploadDocument(models.Model):
    """
    ...
    uploaded_document = models.ForeignKey(
        ...
        related_name="uploaded_document2",
        null=True,
        blank=True,
    ...
    class Meta:
        ...
        verbose_name_plural = " 21.2. [Опросник для пакета документов] Загруженные документы"
